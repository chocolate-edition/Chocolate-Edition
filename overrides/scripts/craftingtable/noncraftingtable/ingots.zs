...
<recipetype:create:compacting>.addRecipe("steel", <constant:create:heat_condition:heated>, [<item:epicsamurai:steel_ingot> * 2], [<item:minecraft:iron_ingot> * 2, <item:epicsamurai:silver_ingot> * 4, <item:minecraft:coal> * 2], [], 200);
<recipetype:create:compacting>.addRecipe("steel2", <constant:create:heat_condition:heated>, [<item:epicsamurai:steel_ingot> * 3], [<item:iter_rpg:gobsteel_scrap> * 2, <item:epicsamurai:silver_ingot> * 4, <item:minecraft:coal> * 2], [], 200);
<recipetype:create:compacting>.addRecipe("steel3", <constant:create:heat_condition:heated>, [<item:epicsamurai:steel_ingot> * 3], [<item:blue_skies:ventium_ingot> * 2, <item:epicsamurai:silver_ingot> * 4, <item:minecraft:coal> * 2], [], 200);

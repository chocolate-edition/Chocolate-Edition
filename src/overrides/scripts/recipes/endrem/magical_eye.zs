craftingTable.addShaped("magical_eye", <item:endrem:magical_eye>, [
	...
	[<tag:items:chocolate:mage>.asIIngredient().anyDamage(),<item:dungeons_mobs:necromancer_staff>.anyDamage().reuse(),<tag:items:chocolate:iceologer>.asIIngredient().anyDamage()]
]);